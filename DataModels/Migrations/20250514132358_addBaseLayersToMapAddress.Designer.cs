...
namespace Server.Migrations
{
    ...
    [Migration("20250514132358_addBaseLayersToMapAddress")]
    partial class addBaseLayersToMapAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.models.MapAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.models.Target", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("CenterFreq")
                        .HasColumnType("double precision");

                    b.Property<DateTime>("DetectedTime")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("Detector_id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Server.models.Target", b =>
                {
                    b.HasOne("Server.models.GisObject", "Detector")
                        .WithMany()
                        .HasForeignKey("Detector_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
