...
public delegate void OnCreateClient();
...
public abstract class Client : IClient
{
    ...
    public event OnCreateClient? OnCreateClient;
...
{
    public void AddClient(Guid clientId, WebSocket webSocket, string ipAddress);
...
public class MoonContext<T> : IMoonContext where T : Client, new()
{
    ...
    public MoonContext(IServiceProvider serviceProvider)
    {
    ...
    public void AddClient(Guid clientId, WebSocket webSocket, string ipAddress)
    {
        ...
        Clients[clientId].setProvider(_serviceProvider);
