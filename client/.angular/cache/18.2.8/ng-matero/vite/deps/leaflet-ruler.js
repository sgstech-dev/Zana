...
// node_modules/leaflet-ruler/src/leaflet-ruler.js
var require_leaflet_ruler = __commonJS({
  "node_modules/leaflet-ruler/src/leaflet-ruler.js"(exports, module) {
      ...
      L2.Control.Ruler = L2.Control.extend({
        ...
        _clicked: function(e) {
          ...
          if (this._clickCount > 0 && !e.latlng.equals(this._clickedPoints[this._clickedPoints.length - 2])) {
            ...
            L2.circleMarker(this._clickedLatLong, this.options.circleMarker).bindTooltip(text, {
              permanent: true,
        ...
        _moving: function(e) {
          if (this._clickedLatLong) {
            ...
            L2.circleMarker(this._movingLatLong, this.options.circleMarker).bindTooltip(text, {
              sticky: true,
              offset: L2.point(0, -40),
...
export default require_leaflet_ruler();
//# sourceMappingURL=leaflet-ruler.js.map
